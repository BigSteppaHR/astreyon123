...
>
    <x-slot:trigger
            class="before:-star[12.5%] size-9 relative z-10 p-0 text-heading-foreground before:absolute before:inset-0 before:-top-[12.5%] before:h-[150%] before:w-[150%]"
            variant="link"
            title="{{ __('AI Tools') }}"
    >
    ...
    <x-slot:dropdown
            class="min-w-80 max-h-[450px] overflow-y-auto"
    >
        @php
