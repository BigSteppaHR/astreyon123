<x-button
        class="lqd-focus-mode-switch size-6 max-lg:size-10 relative hidden items-center justify-center hover:scale-95 hover:bg-transparent max-lg:rounded-full max-lg:border max-lg:dark:bg-white/[3%] md:flex"
        variant="link"
        href="#"
        title="{{ __('Focus Mode') }}"
        x-data="{}"
