...
>
    ...
    >
        ...
        <div class="flex basis-1/3 justify-end gap-2 max-lg:basis-2/3">
            ...
            <button class="mobile-nav-trigger size-10 group relative z-2 flex shrink-0 items-center justify-center rounded-full bg-heading-foreground/10 lg:hidden">
