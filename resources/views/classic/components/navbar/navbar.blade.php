<a
    class="lqd-skip-link bg-background focus-visible:outline-primary pointer-events-none fixed start-7 top-7 z-[90] rounded-md px-3 py-1 text-lg opacity-0 shadow-xl focus-visible:pointer-events-auto focus-visible:opacity-100"
    href="#lqd-titlebar"
>
    {{ __('Skip to content') }}
</a>
...
<button
    class="lqd-navbar-expander size-6 bg-foreground/10 text-heading-foreground hover:bg-heading-foreground hover:text-heading-background fixed start-[--navbar-width] top-[calc(var(--header-height)/2)] z-[999] inline-flex -translate-x-1/2 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border-0 p-0 backdrop-blur-sm transition-all group-[.navbar-shrinked]/body:!start-[80px] group-[.navbar-shrinked]/body:rotate-180 max-lg:hidden"
    x-init
...
<aside
    class="lqd-navbar max-lg:rounded-b-5 rounded-ee-navbar-ee rounded-es-navbar-es rounded-se-navbar-se rounded-ss-navbar-ss border-navbar-border bg-navbar-background text-navbar text-navbar-foreground max-lg:bg-background z-[99] w-[--navbar-width] shrink-0 overflow-hidden border-e font-medium transition-all max-lg:invisible max-lg:absolute max-lg:left-0 max-lg:top-[65px] max-lg:z-[99] max-lg:max-h-[calc(85vh-2rem)] max-lg:min-h-0 max-lg:w-full max-lg:origin-top max-lg:-translate-y-2 max-lg:scale-95 max-lg:overflow-y-auto max-lg:p-0 max-lg:opacity-0 max-lg:shadow-xl lg:sticky lg:top-0 lg:h-screen max-lg:[&.lqd-is-active]:visible max-lg:[&.lqd-is-active]:translate-y-0 max-lg:[&.lqd-is-active]:scale-100 max-lg:[&.lqd-is-active]:opacity-100"
    x-init
    :class="{ 'lqd-is-active': !$store.mobileNav.navCollapse }"
>
    <div class="lqd-navbar-inner -me-navbar-me pe-navbar-pe ps-navbar-ps h-full overflow-y-auto overscroll-contain">
        <div
            class="lqd-navbar-logo pe-navbar-link-pe ps-navbar-link-ps relative flex min-h-[--header-height] max-w-full items-center group-[.navbar-shrinked]/body:w-full group-[.navbar-shrinked]/body:justify-center group-[.navbar-shrinked]/body:px-0 group-[.navbar-shrinked]/body:text-center max-lg:hidden">
            <a
                class="block px-0"
        ...
        >
            <ul class="lqd-navbar-ul">
                ...
                @if ($setting->feature_affilates)
                    ...
                    <x-navbar.item class="pb-navbar-link-pb pe-navbar-link-pe ps-navbar-link-ps pt-navbar-link-pt group-[&.navbar-shrinked]/body:hidden">
                        <div
                            class="lqd-navbar-affiliation border-navbar-divider text-2xs transition-border inline-block w-full rounded-xl border px-8 py-4 text-center leading-tight">
