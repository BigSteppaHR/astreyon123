    ...
    >
        <h1 class="m-0 text-center text-black">
            ...
            @if (setting('user_ai_image_prompt_library') == null || setting('user_ai_image_prompt_library'))
                <button
                    class="lqd-generator-templates-trigger size-10 inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 rounded-full align-middle text-inherit transition-all max-md:h-auto max-md:w-auto max-md:bg-transparent md:hover:bg-heading-background md:hover:text-heading-foreground"
                    type="button"
    ...
    <div class="container relative z-2 -mt-14 flex flex-col">
        <div
            ...
            <x-card
                ...
                size="none"
            >
                <div class="flex flex-wrap justify-between lg:order-5">
                    <div class="lqd-image-generator-tabs-nav flex gap-1">
                        @if (setting('dalle_hidden', 0) != 1)
                            <x-button
                                class="lqd-image-generator-tabs-trigger active rounded-lg px-2 py-1.5 text-2xs font-normal leading-none text-heading-foreground hover:bg-secondary/10 hover:shadow-none [&.active]:bg-secondary/10 [&.active]:text-secondary"
                        ...
                        @if (setting('stable_hidden', 0) != 1)
                            <x-button
                                class="lqd-image-generator-tabs-trigger rounded-lg px-2 py-1.5 text-2xs font-normal leading-none text-heading-foreground hover:bg-secondary/10 hover:shadow-none [&.active]:bg-secondary/10 [&.active]:text-secondary"
                            ...
                            <div class="lqd-image-generator-inputs-wrap relative mb-2 w-full">
                                @foreach (json_decode($openai->questions) ?? [] as $question)
                                    @if ($question->type == 'textarea')
                                        <x-forms.input
                                            class="lqd-image-generator-prompt max-md:min-h-32 h-[53px] resize-none overflow-hidden rounded-2xl border-[3px] bg-background px-4 py-3.5 text-heading-foreground placeholder:text-foreground focus:ring-0 max-md:rounded-md"
                                            id="{{ $question->name }}"
                                            type="textarea"
                                            name="{{ $question->name }}"
                                            x-data
                                ...
                                <x-button
                                    class="lg:size-[30px] absolute end-4 top-1/2 -translate-y-1/2 hover:-translate-y-1/2 hover:scale-110 max-lg:relative max-lg:right-auto max-lg:top-auto max-lg:mt-2 max-lg:w-full max-lg:translate-y-0 lg:p-0"
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div class="lqd-image-generator-inputs-wrap relative w-full">
                                @foreach (json_decode($openai->questions) ?? [] as $question)
                                    @if ($question->type == 'textarea')
                                        <x-forms.input
                                            class="max-md:min-h-32 h-[53px] resize-none overflow-hidden rounded-2xl border-[3px] bg-background px-4 py-3.5 text-heading-foreground placeholder:text-foreground focus:ring-0 max-md:rounded-md"
                        ...
                        >
                            <x-forms.input
                                class="multi_prompts_description max-md:min-h-32 h-[53px] resize-none overflow-hidden rounded-2xl border-[3px] bg-background px-4 py-3.5 text-heading-foreground placeholder:text-foreground focus:ring-0 max-md:rounded-md"
        ...
        <div class="lqd-img-gen-tools-trigger-wrap flex items-center gap-8">
            ...
            >
                ...
                <x-tabler-chevron-down
                    class="size-5 ms-auto rotate-180 transition-transform"
            ...
            @foreach ($ai_tools as $tool)
                ...
                >
                    <h4 class="lqd-img-gen-tool-title relative z-1 m-0 flex items-center gap-3.5 text-lg font-medium">
                        <span
                            class="lqd-img-gen-tool-icon size-6 inline-flex shrink-0 items-center justify-center rounded-lg transition-all [&_svg]:h-auto [&_svg]:w-full"
                            style="color: {{ $tool['color'] }}"
                        >
                            {!! $tool['icon'] !!}
                        </span>
